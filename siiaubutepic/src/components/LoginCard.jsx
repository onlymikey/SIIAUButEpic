...
export default function LoginCard(){
    ...
    return (
        <Card className='w-1/4'>
            <CardHeader className='text-foreground font-sans font-extrabold text-3xl'>Iniciar sesión</CardHeader>
            <CardBody className='gap-3 '>
                ...
                <Input placeholder="********" label="Contraseña" type="password" variant='bordered' onChange={(event) => setPassword(event.target.value)} onBlur={() => handleBlur('password')} isInvalid={error.password}/>
            </CardBody>
